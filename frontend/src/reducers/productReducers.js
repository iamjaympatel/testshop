import {
  ...
  PRODUCT_SELECT_FAIL,
  PRODUCT_SELECTED,
  PRODUCTSELLER_LIST_REQUEST,
  PRODUCTSELLER_LIST_SUCCESS,
  PRODUCTSELLER_LIST_FAIL
...
export const productListsellerReducer = (state = { products: [] }, action) => {
  switch (action.type) {
    case PRODUCTSELLER_LIST_REQUEST:
      return { loading: true, products: [] }
...
export const productselectReducer = (state = { products: [],selectedProducts:[] }, action) => {
  switch (action.type) {
